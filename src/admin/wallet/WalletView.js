...
function WalletView({ wallet, setWallet, seedPhrase, setSeedPhrase, selectedChain }) {
            ...
            children: (
                <>
                    ...
                    <div className="form-group">
                        <label htmlFor="sendToAddress">To:</label>
                        <Input
                            id="sendToAddress"
                            value={sendToAddress}
    ...
    return (
        <div className="container-fluid mt-5" style={{ backgroundColor: '#000033', borderRadius: 10, color: '#fff' }}>
                                ...
                                <div className="text-center">
                                    ...
                                    <div className="d-flex align-items-center">
                                        <Tooltip title={wallet}>
                                            <span>{wallet.slice(0, 24)}...{wallet.slice(-4)}</span>
                                        </Tooltip>
                                        <CopyOutlined
                                            className="ml-2"
